...
Page({
  ...
  getDataList: function (myo,sho) {
    ...
    requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanShop/FenxiaoApi/fenxiaoPoster', { myopenid: myo, shareopenid: sho, version: 1024 }, (info) => {
      this.setData({
