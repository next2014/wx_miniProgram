...
Page({
  ...
  submit:function(e){
    ...
    requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanUser/DistributionApi/applyFenxiao.html', { data: e.detail.value }, (info) => {
      if(info == 1){
        wx.showToast({
          title: '提交成功',
          icon: 'success',
  ...
  onGetVerifyCodeTap:function(e){
    ...
    requestUtil.get(_DuoguanData.duoguan_host_api_url + '/index.php?s=/addon/DuoguanUser/DistributionApi/getVerifyCode.html', { phone: tel }, (info) => {
      var that = this
      //倒计时
      that.setData({
