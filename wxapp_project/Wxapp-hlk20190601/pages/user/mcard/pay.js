...
Page({
  ...
  onSelectCouponTap: function () {
    ...
    let addon_name = "";
    if (this.data.payInfo && this.data.payInfo['addon_name']) {
        addon_name = this.data.payInfo['addon_name'];
    }
    ...
    util.useCoupon({
      ...
      params: { money: this.data.payInfo.total_amount, addon_name: addon_name },
